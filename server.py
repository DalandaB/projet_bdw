...
if __name__ == '__main__':
    ...
    while True:
        try:
            httpd = WebServer(server_address, WebHandler, directory=args.directory, routes_file=args.routes, config_db_file=args.config_db, init_file=args.init, templates_dir=args.templates, no_db=args.no_db)  # dashes (no-db) are converted into underscores (no_db)
